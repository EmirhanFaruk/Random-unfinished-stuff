	...
	def handler(self, c, a):
		...
		while True:
			...
			if data:
				...
				#Oyuncu listesinde olması gereken: id:x,y
				...
				for data in data_list:
					...
					for i in range(len(self.oyuncular)):
						...
						if self.oyuncular[i].split(":")[0] == o_idsi:
				...
				for oyuncu_index in range(len(self.oyuncular)):
					print(self.oyuncular[oyuncu_index])
					geçici_oyuncu_değişkeni = self.oyuncular[oyuncu_index].split(":")[1].split(",")
					gönderilecek_veri = gönderilecek_veri + self.oyuncular[oyuncu_index].split(":")[0] + ":" + geçici_oyuncu_değişkeni[0] + "," + geçici_oyuncu_değişkeni[1] + "|"
